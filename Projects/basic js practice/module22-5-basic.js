...
let sub = num2 - num1; console.log(sub);
let mul = num1 * num2; console.log(mul);
let div = num2 / num1; console.log(div);

let mod = (num2 % num1); console.log(mod);
...
if (num1 < num2) {
    ...
    console.log('Num1 less equal  Num2');
}
else if (num1 >= num2) {
    console.log('Num1 grater equal  Num2');
}
...
if (var1 == 10 && var2 == 11) {
    ...
    console.log('Condition full fill kore nai');
}
if (var1 == 10 || var2 == 11) {
    console.log('Condition A fulfill')
}
...
if (ami == 5) {
    console.log(' Ami to vala na vala loiyai thaiko');
} else if (ami < 5) {
    console.log('Ami kichu koitam chai na')
} else {
    console.log('Amar to onek kichu bolar ache');
}
...
let findBig = [10, 88, 24, 70, 90, 82, 50, 83, 12, 45, 98];

for (let i = 0; i < findBig.length; i++) {
    if (findBig[i] > 80) {
        console.log(findBig[i]);
    }
...
// let one = 2; let two = 3; let three = 4;
// let multiply = one * two * three;
...
console.log('Result is :', multiply(2, 3, 4))
